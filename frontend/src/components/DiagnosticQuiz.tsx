 ...
 * 
 * Step 2 of teaching flow: Diagnostic micro-check (1-3 questions)
 * Assesses prior knowledge before teaching
 */
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-blue-600">Let's see what you already know!</p>
          </div>
        </div>
