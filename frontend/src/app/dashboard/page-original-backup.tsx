  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        // Fetch dashboard data from backend-express
        ...
        if (dashboardResponse.ok) {
          ...
          // Transform backend-express data to match frontend expectations
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Pick Your Tutor</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Maths Tutor */}
            <Link href="/tutor?type=maths" className="group">
              <div className="relative overflow-hidden rounded-2xl shadow-md group-hover:shadow-xl transition duration-300 group-hover:scale-105">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20 text-left">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-xl font-bold text-white">Maths</h3>
                  </div>
            ...
            <Link href="/tutor?type=homework" className="group">
              <div className="relative overflow-hidden rounded-2xl shadow-md group-hover:shadow-xl transition duration-300 group-hover:scale-105">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20 text-left">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-2xl"></span>
                    <h3 className="text-xl font-bold text-white">Homework</h3>
                  </div>
                  <p className="text-white/90 text-sm mb-3">
